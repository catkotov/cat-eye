    ...
    public Receive createReceive() {
        ...
        return receiveBuilder()
                .match(DistributedPubSubMediator.SubscribeAck.class, msg -> {
                    LOGGER.info("Driver.createReceive - was subscribed to topic: " + msg.subscribe().topic());
                })
                .match(Message.CompletedComputation.class, comp -> {
                    LOGGER.info("Driver.createReceive - computation [" + comp.getComputation().getId() + " was COMPLETED.");
                })
